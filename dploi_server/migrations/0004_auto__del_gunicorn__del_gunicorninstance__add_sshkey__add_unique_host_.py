...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SSHKey'
        db.create_table('dploi_server_sshkey', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='dploi_ssh_keys', to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128)),
            ('key', self.gf('django.db.models.fields.TextField')()),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=16)),
        ))
        db.send_create_signal('dploi_server', ['SSHKey'])

        # Adding M2M table for field administrator_groups on 'Host'
        db.create_table('dploi_server_host_administrator_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('host', models.ForeignKey(orm['dploi_server.host'], null=False)),
            ('group', models.ForeignKey(orm['auth.group'], null=False))
        ))
        db.create_unique('dploi_server_host_administrator_groups', ['host_id', 'group_id'])

        # Adding unique constraint on 'Host', fields ['name']
        db.create_unique('dploi_server_host', ['name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Host', fields ['name']
        db.delete_unique('dploi_server_host', ['name'])
        ...
        db.delete_table('dploi_server_sshkey')

        # Removing M2M table for field administrator_groups on 'Host'
        db.delete_table('dploi_server_host_administrator_groups')
