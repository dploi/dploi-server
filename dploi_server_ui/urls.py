...
from dploi_server_ui.views import OverviewView, RealmList, ApplicationList, ApplicationDetail, ApplicationUpdate, DeploymentUpdate, DeploymentDetail, ApplicationCreate, DeploymentCreate
...
urlpatterns = patterns('',
    ...
    url(r'^applications/create/$', ApplicationCreate.as_view(), name="dploi_application_create"),
    ...
    url(r'^applications/deployment/create/$', DeploymentCreate.as_view(), name="dploi_deployment_create"),
